...
function TipoRegistro({ clientType, selectTypeClient }) {
  return (
      ...
      <div className="bg-white h-full">
        <div className="mt-10 mx-24">
          <h1 className="mt-24 font-bold text-4xl">
            &iquest; Editor o{" "}
            <span className="text-unancor-orange">Anunciante</span>?
          </h1>
          <h2 className="text-sm mt-5">
            Elige tu perfil en Unancor, como Editor podr&aacute;s trabajar con
            nosotros generando contenido y como Anunciante podr&aacute;s
            registrar tu proyecto hacer seguimiento , incrementar su crecimiento
            en la red.
          </h2>
        </div>
        <div className="flex flex-col space-y-8 mt-24 mx-40">
          <Link
            to="/CrearMedio"
            ...
            onClick={() => selectTypeClient("editor")}
          >
            <div className="absolute z-30 w-20 h-20 top-1.5 left-4 bg-unancor-orange opacity-10 group-hover:bg-white"></div>
            <svg
              viewBox="0 0 76 80"
              fill="none"
              className="absolute z-20 w-14 h-14 top-5 left-7"
            >
              <g
                clipPath="url(#clip0)"
                stroke="#FF6139"
              ...
              >
                <path
                  className="group-hover:stroke-current group-hover:text-white"
            ...
            <span className="absolute z-10 left-48  font-bold text-unancor-orange text-2xl group-hover:text-white">
              Editor
            </span>
          </Link>
          <Link
            to="/TipoCliente"
            className="group relative bg-transparent border-2 hover:bg-unancor-blue border-unancor-blue font-bold py-2 px-4 rounded-lg inline-flex items-center w-full h-24 mt-16"
            onClick={() => selectTypeClient("anunciante")}
          >
            <div className="absolute z-30 w-20 h-20 top-1.5 left-4 bg-unancor-blue opacity-10 group-hover:bg-white"></div>
            <svg
              width="76"
              height="80"
              viewBox="0 0 76 80"
            ...
            <span className="absolute z-10 left-40  font-bold text-unancor-blue text-2xl group-hover:text-white">
              Anunciante
            </span>
          </Link>
        </div>

...
function TipoRegistro({ selectTypeClient }) {
  return (
    <div className="bg-white h-full">
      <div className="mt-10 mx-24">
        ...
        <h2 className="text-sm mt-5">
          ...
          nosotros generando contenido y como Anunciante podr&aacute;s registrar
          tu proyecto hacer seguimiento , incrementar su crecimiento en la red.
        </h2>
      </div>
